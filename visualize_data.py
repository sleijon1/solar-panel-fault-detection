...
def plot_date_and_parameter(lower_limit=None, upper_limit=None, parameter='air_temperature_id', path="smhi.csv"):
...
def example_plot():
	plot_date_and_parameter(parameter=["air_temperature_id"])
